...
export type TableCallbackContext<Row extends TableRow = TableRow, Column = STableColumn<Row>, Action = STableButton<Row>> = Partial<Row> & {
    row?: Row;
...
export type TableContextHandler<TResult = any, Row extends TableRow = TableRow> = (context: TableCallbackContext<Row>) => TResult;
...
export type TableMaybeFn<TResult = any, Row extends TableRow = TableRow> = TResult | TableContextHandler<TResult, Row> | TableLegacyHandler<TResult>;
...
export type TableFilter<Row extends TableRow = TableRow> = (context: TableFilterContext<Row>, row: Row, scope: TableScope<Row>) => any;
...
export type TableModelValue<Row extends TableRow = TableRow> = Row[] | Row | string | number | boolean | null | undefined;
