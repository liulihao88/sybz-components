...
const deleteConfirm = () => {
  confirm('确定删除文件<code type="warning">成华AI服务申请表.xlsx</code>吗？删除后无法恢复。 ', {
    title: '删除确认',
    theme: 'chenghua',
  })
}
...
<template>
  <div class="chenghua-confirm-demo">
    <s-button theme="chenghua" type="danger" @click="deleteConfirm">删除确认</s-button>
