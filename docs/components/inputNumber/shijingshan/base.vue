...
<template>
  <div class="input-number-shijingshan-demo">
    <div class="input-number-shijingshan-demo__meta">
      <span>属性: theme</span>
      ...
      <span>可选值: string | number</span>
      <span>默认值: ''</span>
      <span>属性: controls-position</span>
      <span>可选值: '' | 'right'</span>
      <span>默认值: 'right'</span>
    </div>
...
.input-number-shijingshan-demo {
  display: flex;
  flex-direction: column;
  gap: 14px;
}

.input-number-shijingshan-demo__meta {
  display: flex;
  flex-wrap: wrap;
  gap: 8px 12px;
...
.input-number-shijingshan-demo__list {
  display: flex;
  flex-wrap: wrap;
  gap: 14px;
  align-items: center;
