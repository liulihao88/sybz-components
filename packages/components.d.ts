...
declare module 'vue' {
  export interface GlobalComponents {
     ...
     *
     * s-menu 递归菜单组件，支持路由、图标、分组、默认展开、内置头尾区域以及公共组件主题。
     */
     ...
     *
     * s-select 下拉选择组件，支持 options 配置和默认插槽直接传入 el-option，两种模式均支持快速切换，按钮仅由 showQuick 控制，空选项时仍显示；options 模式额外支持全选、反选和完整选项上下文。
     */
...
export type SMenuComponent = (typeof import('./types/components/menu'))['default']
