...
export type SIconSource = 'auto' | 'element-plus' | 'iconify' | 'css' | 'svg' | 'url'
...
export type SItemAlign = 'start' | 'center' | 'end' | 'stretch'
export type SItemExtraPlacement = 'header' | 'side' | 'bottom'
export type SItemStyleKey =
  | 'root'
  | 'row'
  | 'main'
  | 'prefix'
