...
describe('base utils', () => {
  ...
  it('normalizes width values', () => {
    ...
    expect(processWidth('calc(100% - 24px)', true)).toBe('calc(100% - 24px)')
    expect(processWidth('min(100%, 1200px)')).toEqual({ width: 'min(100%, 1200px)' })
    expect(processWidth('max(50vw, 320px)', true)).toBe('max(50vw, 320px)')
    expect(processWidth('clamp(320px, 80vw, 1200px)', true)).toBe('clamp(320px, 80vw, 1200px)')
    expect(processWidth('var(--content-width)', true)).toBe('var(--content-width)')
