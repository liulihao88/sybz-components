...
const TYPED_COMPONENT_PROPS = new Map([
  ...
  [
    'SMenu',
    {
      ...
      slots: ['header', 'append', 'footer'],
      instanceMembers: ["$emit: (event: 'update:modelValue' | 'update:collapse' | 'select', ...args: any[]) => void"],
      hoverProps: {
...
const ELEMENT_WRAPPER_CONFIGS = {
  ...
  table: {
    ...
    description:
      'Element Plus Table；s-table 自有属性包括主题、背景色、border（表格及单元格边框）、disabled（禁用分页和操作按钮）、分页、选择和列配置。',
  },
  tooltip: {
